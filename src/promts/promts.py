...
Ответ для проверки:
{response}"""),
                    ("human", """Требуется ли корректировка ответа? Если да, то:
                     1. Предложи улучшенную версию ответа;
                     2. Обязательно помести эту версию между тегами <perfect_answer> и </perfect_answer>."""),
                    ("human", "Если не требуется корректировка, то ответь коротко и лаконично: 'OK'")
                ]
            )
